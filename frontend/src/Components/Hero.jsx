...
const slides = [
  ...
  {
    title: "Delightfully Sweet Treats",
    subtitle: "Savor the rich, traditional flavors of Siwayi, a classic South Indian sweet. ",
    buttonText: "Explore Siwayi",
  ...
  {
    title: "Pastries – Sweet Bites of Joy",
    subtitle: "Indulge in soft, buttery, and freshly baked pastries that melt in your mouth. Perfect for tea time, dessert, or a quick sweet treat anytime.",
